    ...
    public Map<String, Object> markAttendance(@PathParam("event_id") String eventId, Map<String, String> body) {
        try {
            ...
            CosmosItemResponse<Map> response = container.readItem(eventId, pk, Map.class);
            Map<String, Object> event = response.getItem();

            if (event == null) return Collections.singletonMap("error", "Event ID not found.");

            // Safe List Initialization
            List<String> attendance = (List<String>) event.get("attendance_list");
            ...
            return Collections.singletonMap("error", "Attendance Failed: " + e.getMessage());
        }
    }
    ...
    public Map<String, Object> rateEvent(@PathParam("event_id") String eventId, Map<String, Object> ratingData) {
        try {
            ...
            // Safe List Initialization
            List<Map<String, Object>> ratings = (List<Map<String, Object>>) event.get("ratings");
            ...
            return Collections.singletonMap("error", "Rating Failed: " + e.getMessage());
        }
    }
        }